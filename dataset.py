...
#
# # from totaldataset import totaldataset
# from splitdataset import totaldataset
#
#
...
#     def __init__(self, split_train, transform=None):
#         self.img_path = [x[0] for x in split_train]
#         self.targets = [x[1] for x in split_train]
...
#     def __init__(self, split_valid, transform=None, class_map=None):
#         self.img_path = [x[0] for x in split_valid]
#         self.targets = [x[1] for x in split_valid]
#         self.transform = transform
...
#
#         split_train, split_valid = totaldataset(root)
#
#
#         train_dataset = LT_Dataset(split_train, transform=transform_train)
#         eval_dataset = LT_Dataset_Eval(split_valid, transform=transform_test, class_map=train_dataset.class_map)
#
...
class Food_LT(object):
    def __init__(self, distributed, root="", batch_size=60, num_works=40):
        ...
        transform_train = transforms.Compose([
            transforms.RandomResizedCrop(size=224, scale=(0.75, 1.5), ratio=(0.75, 1.333333)),
            transforms.RandomHorizontalFlip(),
